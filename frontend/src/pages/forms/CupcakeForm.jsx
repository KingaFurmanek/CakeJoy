...
function CupcakeForm() {
    ...
    const validateForm = () => {
        const { quantity,flavours,sprinkles, colours, additionalOptions, date, additionalInfo } = formData;
        return !(!quantity || !colours || !date || !additionalOptions.length || !flavours.length || !additionalInfo || !sprinkles.length);
